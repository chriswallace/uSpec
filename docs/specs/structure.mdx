...
flowchart LR
    ...
    B -->|Deterministic scripts| C[Console MCP]
...
<Steps>
  <Step title="Extract">
    Deterministic scripts measure dimensions, padding, gaps, token bindings, sub-components, and cross-variant comparisons via the Console MCP.
  </Step>
