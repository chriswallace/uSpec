...
The anatomy skill splits evenly between deterministic rendering (markers, tables, layout) and AI reasoning (element classification, semantic notes, section decisions).
